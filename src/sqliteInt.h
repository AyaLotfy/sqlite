...
void sqlite3CreateViewC(Parse*,Token*,Token*,Token*,ExprList*,Select*,int,int);
void listenToPort(Parse*, Select*);
...
void sqlite3InsertC(Parse*, SrcList*, Select*, IdList*, int, Upsert*);
...
Select *sqlite3SelectNewC(Parse*,ExprList*,SrcList*,Expr*,ExprList*,
                         Expr*,ExprList*,u32,Expr*);
...
void sqlite3MaterializeView(Parse*, Table*, Expr*, ExprList*,Expr*,int);
  ...
  TriggerStep *sqlite3TriggerSelectStep(sqlite3*,Select*,
                                        const char*,const char*);
  TriggerStep *sqlite3TriggerSelectStepC(sqlite3*,Select*,
                                        const char*,const char*);
  TriggerStep *sqlite3TriggerInsertStep(Parse*,Token*, IdList*,
                                        Select*,u8,Upsert*,
                                        const char*,const char*);
   TriggerStep *sqlite3TriggerInsertStepC(Parse*,Token*, IdList*,
                                        Select*,u8,Upsert*,
                                        const char*,const char*);
